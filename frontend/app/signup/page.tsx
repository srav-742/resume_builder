...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4 overflow-hidden relative">
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-indigo-500/5 rounded-full blur-[120px] translate-x-1/2 -translate-y-1/2"></div>
      <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-purple-500/5 rounded-full blur-[120px] -translate-x-1/2 translate-y-1/2"></div>
        ...
        <div className="p-8 lg:p-16 flex flex-col justify-center">
          <div className="max-w-md mx-auto w-full">
            ...
            <div className="space-y-2 mb-8 animate-in fade-in slide-in-from-bottom-2 duration-700">
              <h2 className="text-4xl font-black text-slate-900">Join the Elite.</h2>
              <p className="text-slate-500 font-medium">Create your professional identity today.</p>
            </div>

            <form onSubmit={handleSubmit} className="space-y-5 animate-in fade-in slide-in-from-bottom-4 duration-1000">
              <div className="group">
                <label className="block text-sm font-bold text-slate-500 mb-2 group-focus-within:text-indigo-600 transition-colors">Full Name</label>
                <input
                  type="text"
                  value={name}
              ...
              <div className="group relative">
                ...
                <button
                  ...
                  className="absolute right-6 top-[46px] text-slate-400 hover:text-white transition"
                >
            ...
            <p className="mt-8 text-center text-slate-500 font-medium">
              Already have an account? <Link href="/login" className="text-indigo-400 font-black hover:underline underline-offset-4">Login</Link>
            </p>
          </div>
        </div>
        ...
        <div className="hidden lg:flex flex-col items-center justify-center p-16 relative overflow-hidden bg-indigo-600">
          ...
          <div className="relative z-10 text-center">
            <div className="mb-12 relative">
              <div className="absolute inset-0 bg-white/20 blur-[80px] rounded-full scale-150 animate-pulse"></div>
              <img
                src="/images/resumesignup image.png"
                alt="Showcase"
                className="w-full max-w-sm h-auto object-contain rounded-3xl shadow-2xl relative z-10 transform rotate-3 hover:rotate-0 transition-transform duration-700 mx-auto"
              />
            </div>

            <h3 className="text-4xl font-black text-white mb-6 leading-tight max-w-sm mx-auto">
              Your Future Self Will Thank You.
            </h3>
            <p className="text-white/80 text-lg leading-relaxed max-w-sm mx-auto">
              Join thousands of professionals landing jobs through AI-powered skill matching and professional resume building.
            </p>
          </div>
