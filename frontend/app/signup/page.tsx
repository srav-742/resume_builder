        ...
        <div className="p-8 lg:p-16 flex flex-col justify-center">
          <div className="max-w-md mx-auto w-full">
            ...
            <div className="space-y-2 mb-8 animate-in fade-in slide-in-from-bottom-2 duration-700">
              ...
              <p className="text-slate-400 font-medium">Create your professional identity today.</p>
            </div>

            <form onSubmit={handleSubmit} className="space-y-5 animate-in fade-in slide-in-from-bottom-4 duration-1000">
              <div className="group">
                <label className="block text-sm font-bold text-slate-400 mb-2 group-focus-within:text-indigo-400 transition-colors">Full Name</label>
                <input
                  type="text"
                  value={name}
